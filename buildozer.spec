...
requirements = python3,kivy,certifi,charset-normalizer,docutils,idna,Kivy==2.3.0,Kivy-Garden,pillow,pypiwin32,requests,split-image,urllib3
...
# presplash.filename = images/pollen_app_icon.png

# (str) Icon of the application
icon.filename = images/pollen_app_icon.png
